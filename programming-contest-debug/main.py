...
def programming_contest():
    return webpage(navigation_bar=navigation_bar('cccs'),
                   header=header(title('programming-contest')),
                   body=r'''
    ...
    ''' % {
        'toc':'TOC', # toc(),
        'useful_stuff': 'USEFUL STUFF', # useful_stuff(),
        'events_t_shirts_etc': 'EVENTS T SHIRTS', #events_t_shirts_etc(),
        'outreach': 'OUTREACH', # outreach(),
        'others': 'OTHERS', # others(),
        'software': 'SOFTWARE', # software(),
        'tutorials': 'TUTORIAL', # tutorials(),
        'wanna_feed_your_brain': 'WANNA FEED YOUR BRAIN', # wanna_feed_your_brain(),
        'courses': 'COURSES', #courses.index(),
    })

if __name__ == '__main__':
    writefile('index.html',                            s=programming_contest())
