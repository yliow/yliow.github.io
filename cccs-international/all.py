...
s = r'''
Nepal=
Japan=The following is the <a href="https://yliow.github.io/cccs-international/cccs-japan/docs/cccs-japan-summary-sheet.pdf">summary sheet / 日本語訳付き概要シート</a> (PDF) and <a href='https://yliow.github.io/cccs-international/cccs-japan/docs/cccs-japan-poster-3-upscale.pdf'>flyer</a> (PDF). 
