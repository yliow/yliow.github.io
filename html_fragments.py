...
def cs_hangout():
    ...
    <ul>
    <li>MWF 4:30PM-6:30PM, BRN100 (BRN = Brown Hall)
    <li>TuTh 3PM-5PM, BUH104 [SPRING2024 -- to be determined]
    </ul>
    '''
def ciss145():
...
def academic_calendar():
    return r'<a href="https://www.ccis.edu/-/media/www/files/directory/registrar/2023-2024/2023-semester-academic%20calendar-pdf.ashx?la=en&hash=05666FB795D2B4C73C8D91E263D7CA39">Academic calendar</a>'
