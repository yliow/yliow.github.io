...
def companies():
    ...
    | <a href='https://docs.google.com/document/d/1SPCaGycXVdnCXX5L-b2FzQ01kXcIjCkNOE8TyEj_PC4/edit?usp=sharing'>here</a>
    </ul>'''
...
def grad_school():
    ...
    xs.sort()
    return 'Grads of CCCS went to the following graduate schools: <ul>%s</ul>' % ''.join(['<li>%s</li>' % x for x in xs])
