...
def cccs_discord():
    return r"""<a href="https://discord.gg/UDCX6wF">CCCS discord</a> (<a href="https://discordapp.com/download">discord app</a>)
    <ul>
...
<li>How to withdraw from a class: (form: <a href="https://drive.google.com/file/d/1qdu3EVnCXhxvEpl3lI_RPYFYqN_O1flu/view?usp=sharing">Course withdrawal</a>)
