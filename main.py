...
def toc():
    ...
    <a href='https://docs.google.com/document/d/1UDEPq7GJzLl9w3-bl4fQaImlhY_l80M-QqCj2ud3o5g'>AI</a></li>
...
def tutorials():
    ...
    data = [('pdfs/vmware/vmwareplayer.pdf',
            ...
            ('pdfs/memory-debugging/main.pdf',
             ...
             ('pdfs/latextool/main.pdf',
              'latextool.pdf', 
              'How to draw using latextool.'),
...
<ul>
    ...
    | <a href='https://drive.google.com/drive/folders/1FlF_EY1n5t8UbcXkdtACZxCq5OGjVgbj?usp=sharing'>Software folder</a></li>
    <li>Link for SDL <a href="https://drive.google.com/file/d/1qjM_Aayja4dOFHYdT5Bnwkl_ZKp-QeaM/view?usp=sharing">demo.tar</a>
